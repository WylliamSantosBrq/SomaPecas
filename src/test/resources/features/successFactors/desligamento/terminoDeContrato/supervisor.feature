...
@terminoDeContrato @supervisor
Feature: Desligamento - Término de Contrato - Supervisor
	...
	Scenario Outline: Solicitar desligamento - Sem alerta
		...
		Examples: 
			| linha | motivo                       |
			| 3     | Término de Contrato Aprendiz |
	...
	Scenario Outline: Solicitar desligamento - Com alerta impeditivo
		...
		Examples: 
			| linha | motivo                       |
			| 9     | Término de Contrato Aprendiz |

	#Cenário 19
	@semAlerta @reprovacao @reprovacaoGerente
	Scenario Outline: Desligamento reprovado - Gerente - Sem alerta
		Given que eu carregue todos os dados da linha <linha> da aba "Término de Contrato" da planilha "MassaDeDadosRH.xlsx"
		#
		And que eu represente o supervisor
		And que eu clique em "Workflow RH"
		...
		Examples: 
			| linha | motivo                       |
			| 20    | Término de Contrato Aprendiz |
	...
	Scenario Outline: Devolução [Gerente] - Sem alerta
		...
		#COMO SUPERVISOR NÃO PODE SOLICITAR DESLIGAMENTO DE ESTAGIARIO NÃO ALTEREI NO FLUXO DE EDIÇÃO O MOTIVO
		Examples: 
			| linha | motivo                       |
			| 26    | Término de Contrato Aprendiz |
