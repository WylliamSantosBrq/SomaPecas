...
@desligamento @semJustaCausa @gerente
Feature: Desligamento - Sem justa causa - Gerente
	...
	Scenario Outline: Solicitar desligamento - Sem alerta
		...
		Examples: 
			...
			| 20    | Baixo desempenho                         |
			| 21    | Fraude                                   |
			| 22    | Excesso de ausências no trabalho         |
			| 23    | Falta de adaptação à escala de trabalho  |
			| 24    | Transição de Carreira                    |
			| 25    | Aposentadoria                            |
			| 26    | Falta de adaptação à cultura da empresa  |
			| 27    | Reestruturação                           |
			| 28    | Falta de adaptação à área/função/produto |
	...
	Scenario Outline: Desligamento reprovado - Consultor RH - Sem alerta
		...
		Examples: 
			| linha | motivo                                  |
			| 96    | Falta de adaptação à cultura da empresa |
	...
	Scenario Outline: Desligamento reprovado - Ambulatório - Sem alerta
		...
		Examples: 
			| linha | motivo                                   |
			| 98    | Falta de adaptação à área/função/produto |

	#Cenário 94
	@comAlerta @naoImpeditivo @reprovacao @reprovacaoConsultorRH
	Scenario Outline: Desligamento reprovado - Consultora RH - Com alerta não-impeditivo
		Given que eu carregue todos os dados da linha <linha> da aba "Sem Justa Causa" da planilha "MassaDeDadosRH.xlsx"
		#
		And que eu represente o gerente
		And que eu clique em "Workflow RH"
		...
		Examples: 
			| linha | motivo                           |
			| 95    | Excesso de ausências no trabalho |
	...
	Scenario Outline: Devolução [ADM Pessoal] - Com alerta impeditivo
		...
		Examples: 
			| linha | motivo                           |
			| 130   | Excesso de ausências no trabalho |
	...
	Scenario Outline: Devolução [Consultora RH] - Sem alerta
		...
		Examples: 
			...
			| 122   | Baixo desempenho | Fraude          |

	#Cenário 122
	@comAlerta @naoImpeditivo @devolucao @devolucaoAmbulatorio
	Scenario Outline: Devolução [Ambulatório] - Com alerta
		Given que eu carregue todos os dados da linha <linha> da aba "Sem justa causa" da planilha "MassaDeDadosRH.xlsx"
		#
		And que eu represente o gerente
		And que eu clique em "Workflow RH"
		...
		And que eu clique em "DESLIGAR"
		And preencher os campos obrigatórios com motivo "<motivo>"
		And o sistema irá apresentar os alertas esperados
		And que eu clique em "CONTINUAR"
		Then validar as informações preenchidas no cadastro
		Given que eu clique em "ENVIAR"
		And que eu clique em "SIM"
		...
		Examples: 
			| linha | motivo                           |
			| 123   | Excesso de ausências no trabalho |
