...
@desligamento @comJustaCausa @coordenador
Feature: Desligamento - Com Justa Causa - Coordenador
	...
	Scenario Outline: Devolução [ADM pessoal] - Sem alerta
		...
		Examples: 
			...
			| 31    | Fraude              | Abandono de emprego |
			| 32    | Abandono de emprego | Fraude              |
